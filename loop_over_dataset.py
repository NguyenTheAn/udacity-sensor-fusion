...
exec_detection = ['perform_tracking'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
...
while True:
    try:
        ...
        if 'show_range_image' in exec_list:
            ...
            cv2.imwrite("range_image.png", img_range)
        ...
        if 'perform_tracking' in exec_list:
            ...
            if 'show_tracks' in exec_list:
                ...
                if 'make_tracking_movie' in exec_list:
                    ...
                    fname = 'results_images/tracking%03d.png' % cnt_frame
